...
<body style="background: #C6D9F1" class="cs-HTML is-theme-classic" role="application">
  <!-- 360 -->
  ...
  <div class="mobile-load-title-overlay">
    <div class="mobile-load-title">PELAYANAN PRIMA</div>
  </div>
  <script>
